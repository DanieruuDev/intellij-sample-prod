...
//
//    try (InputStream inputStream = TypeReference.class.getResourceAsStream("/data/
//        todoRepository.saveAll(objectMapper.readValue(inputStream, new TypeReference<List
//
//    }
//}
//}
